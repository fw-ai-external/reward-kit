...
1. Learn about the [Core Data Types](core_data_types.mdx) used in reward functions
2. Explore [Evaluation Workflows](evaluation_workflows.mdx) for testing and deployment
3. See [Code Examples](../examples/basic_examples/basic_reward_function.mdx) for practical implementations
