...
- [Dataset Configuration Guide](developer_guide/dataset_configuration_guide.md): Understand how to configure datasets using YAML.
...
- [Integrating with Braintrust](integrations/braintrust_integration.mdx): Bridge Reward Kit with the Braintrust SDK.
...
### Tutorials
- [Creating Your First Reward Function](tutorials/creating_your_first_reward_function.mdx): Step-by-step guide to creating a reward function
