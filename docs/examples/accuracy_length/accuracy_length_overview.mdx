...
The [cosine_scaled_example.py](../../../examples/accuracy_length/cosine_scaled_example.py) script demonstrates the reward function's behavior with different types of responses:
...
- [Basic Reward Functions](./examples/basic_examples/reward_functions_overview.mdx)
