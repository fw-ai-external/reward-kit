...
1. Learn about [Advanced Reward Functions](../examples/advanced_examples/advanced_reward_functions.mdx)
2. Explore [Core Data Types](../developer_guide/core_data_types.mdx) for more flexibility
3. Try integrating [Multiple Metrics](multiple_metrics.mdx) into a single evaluator
