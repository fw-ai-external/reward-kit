...
from reward_kit.evaluation import preview_folder_evaluation, deploy_folder_evaluation
    ...
    samples = [
        {
            "messages": [
                ...
                {"role": "assistant", "content": "Machine learning is a field of AI that uses algorithms to learn patterns from data. Specifically, it enables computers to improve their performance on tasks through experience. For example, a machine learning model might analyze past customer behavior to predict future purchases."}
            ]
        },
        {
            "messages": [
    ...
    try:
        ...
        if deploy_answer.lower() == 'y':
            try:
                ...
                print(f"Successfully deployed evaluator: {result.get('name', 'folder-based-eval')}")
