...
def test_dataset_format():
    ...
    assert "important_document.txt" in data["prompt"], "Prompt doesn't mention target file"
    assert "/data/source_files/" in data["prompt"], "Prompt doesn't mention source directory"
...
def test_reward_function_import():
    ...
    assert hasattr(reward_function, "mcp_filesystem_move_reward"), "Reward function not found"
