...
class ResponseCache:
    ...
    def _generate_key(
        ...
        key_material = f"{sample_id}-{system_prompt}-{user_query}-{model_name}-{temperature}"
    ...
    def get(
        ...
        cache_key = self._generate_key(sample_id, system_prompt, user_query, model_name, temperature)
