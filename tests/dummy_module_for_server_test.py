from reward_kit.models import EvaluateResult, Message, MetricResult # Ensure MetricResult is imported
...
def dummy_reward_func(
    ...
    **kwargs: Any
    ...
    return EvaluateResult(
        ...
        reason=reason,
        is_score_valid=True,
        metrics={"dummy_metric": MetricResult(score=0.75, is_score_valid=True, reason="A dummy metric")} # Correctly use MetricResult
    )
...
def dummy_reward_func_invalid_return(
    ...
    **kwargs: Any
    ...
    """
    return {"score": 0.1, "reason": "This is a dict, not EvaluateResult", "is_score_valid": True, "metrics": {}}
