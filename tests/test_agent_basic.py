...
from reward_kit.agent import ToolRegistry, Database, AgentEvaluator, load_task_from_file
...
def test_openai_tools_format():
    ...
    @registry.tool(description="Test tool", parameters={"param1": str, "param2": int})
    ...
    assert tools[0]["function"]["parameters"]["properties"]["param1"]["type"] == "string"
    assert tools[0]["function"]["parameters"]["properties"]["param2"]["type"] == "integer"
...
async def test_database_setup():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        db = Database(db_path, seed_sql="CREATE TABLE test (id INTEGER PRIMARY KEY, value TEXT);")
        await db.setup()
...
""")
        ...
        try:
            ...
            result = await evaluator.execute_tool(run_id, "echo", {"text": "test"})
            assert result == "test"
