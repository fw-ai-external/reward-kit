...
from tests.dummy_module_for_server_test import dummy_reward_func, not_a_reward_function, dummy_accepts_args_returns_string
...
class TestServerEndpoints:
    ...
    def test_health_check_no_function_loaded(self):
        ...
        assert response.json() == {"status": "error", "reason": "Reward function not loaded"}
